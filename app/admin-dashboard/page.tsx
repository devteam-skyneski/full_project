        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-100 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2 bg-white rounded-lg px-3 py-1 cursor-pointer hover:bg-gray-50 transition">
                    <span className="text-gray-700 text-sm">This Semester</span>
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      <span className="text-4xl font-bold text-gray-800">84.3%</span>
                      <p className="text-gray-600 text-sm mt-1">Avg. Score (All Departments)</p>
                    </div>
              ...
              <div className="bg-gray-100 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-semibold text-gray-800">Faculty Overview</h3>
                  <a href="#teachers" className="text-blue-600 hover:underline text-sm font-medium">
                    Manage All
                  </a>
                </div>
