  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 mt-24">
        {/* Hero Card placed in a two-column top layout so it sits on the left while reserving a right sidebar */}
        <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-6 items-start">
          ...
          {/* Right column reserved for sidebar content (keeps placement only, no content changed) */}
